...
public class Wave {
    ...
    private BooleanProperty vagueAutorisee;
    ...
    public Wave(Terrain terrain, Game g) {
        ...
        vagueAutorisee = new SimpleBooleanProperty(false);
    }

    public void autoriserVagues() {
        vagueAutorisee.set(true);
    }

    public BooleanProperty vagueAutoriseeProperty() {
        return vagueAutorisee;
    }
    ...
    public void wave() throws InterruptedException {
        ...
        } else if (frameAct > 19300 && game.bossEstVaincu()) {
            setGagne(true);
        }
